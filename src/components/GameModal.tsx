...
export const GameModal = ({ gameState, distance, restartGame }: GameModalProps) => (
  <div className="w-[330px] px-6 text-black fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-4 rounded-3xl shadow-lg text-center">
    ...
    {gameState === 'success' ? <p className="mt-2 text-lg">기록: {Math.floor(distance)}m</p> : <p className="mt-2">도착선과의 거리가 400m 이내여야 합니다.</p>}
